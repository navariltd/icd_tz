...
class Manifest(Document):
    ...
    def update_housebi_details(self, house_bl_sheet):
        for row in house_bl_sheet.iter_rows(min_row=2, values_only=True):
            ...
            housebi.exporter_name = row[24]
            housebi.exporter_tel = row[25]
            housebi.exporter_address = row[26]
            housebi.exporter_tin = row[27]
            housebi.cosignee_name = row[28]
            housebi.cosignee_tel = row[29]
            housebi.cosignee_address = row[30]
            housebi.cosignee_tin = row[31]
            housebi.notify_name = row[32]
            housebi.notify_tel = row[33]
            housebi.notify_address = row[34]
            housebi.notify_tin = row[35]
            housebi.shipping_mark = row[36]
            housebi.oil_type = row[37]
